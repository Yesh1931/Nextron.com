...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const routes = [
        { path: '#/', name: 'home', loadView: () => import('./views/home.js') },
        { path: '#/login', name: 'login', loadView: () => import('./views/login.js') },
        { path: '#/concepts', name: 'concepts', loadView: () => import('./views/concepts.js') },
        { path: '#/concept/diode', name: 'concepts', loadView: () => import('./views/diode.js') },
        { path: '#/concept/transistor', name: 'concepts', loadView: () => import('./views/transistor.js') },
        { path: '#/concept/gates', name: 'concepts', loadView: () => import('./views/gates.js') },
        { path: '#/concept/flipflops', name: 'concepts', loadView: () => import('./views/flipflops.js') },
        { path: '#/concept/signals', name: 'concepts', loadView: () => import('./views/signals.js') },
        { path: '#/concept/networks', name: 'concepts', loadView: () => import('./views/networks.js') },
        { path: '#/concept/microcontrollers', name: 'concepts', loadView: () => import('./views/microcontrollers.js') },
        { path: '#/concept/dsp', name: 'concepts', loadView: () => import('./views/dsp.js') },
        { path: '#/concept/comms', name: 'concepts', loadView: () => import('./views/comms.js') },
        { path: '#/concept/vlsi', name: 'concepts', loadView: () => import('./views/vlsi.js') },
        { path: '#/concept/embedded', name: 'concepts', loadView: () => import('./views/embedded.js') },
        { path: '#/concept/optical', name: 'concepts', loadView: () => import('./views/optical.js') },
        { path: '#/sandbox', name: 'sandbox', loadView: () => import('./views/sandbox.js') },
        { path: '#/circuit-lab', name: 'circuit-lab', loadView: () => import('./views/circuitlab.js') },
        { path: '#/math-center', name: 'math-center', loadView: () => import('./views/mathcenter.js') },
        { path: '#/notes', name: 'notes', loadView: () => import('./views/notes.js') },
        { path: '#/study-hub', name: 'study-hub', loadView: () => import('./views/studyhub.js') },
        { path: '#/quiz', name: 'quiz', loadView: () => import('./views/quiz.js') },
        { path: '#/quiz-analytics', name: 'quiz-analytics', loadView: () => import('./views/quiz-analytics.js') },
        { path: '#/leaderboard', name: 'leaderboard', loadView: () => import('./views/quiz-leaderboard.js') },
        { path: '#/dashboard', name: 'dashboard', loadView: () => import('./views/dashboard.js') },
        { path: '#/about', name: 'about', loadView: () => import('./views/about.js') },
        { path: '#/404', name: 'notfound', loadView: () => import('./views/notfound.js') }
    ];
